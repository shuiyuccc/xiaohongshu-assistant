...
## 四、仿写规则
生成新标题时：
- 至少使用【句式模板库】或【高频词汇库】或【语气特征】中的一项
- 可以组合使用，但不强制要求全部使用
- 禁止直接复制原标题的完整短语
- 根据图片内容灵活选择最适合的表达方式
...
3. **动态示例**（假设博主风格如下）
   - 句式模板："{情绪词}！{场景}的{元素}真的{形容词}"
   - 高频词汇：情绪词="绝了"、场景="晨袍"、元素="光影"
   - 生成示例："绝了！晨袍的光影真的封神"
   
   - 句式模板："谁懂啊！{动作}的{场景}，{人群}都{反应}了"
   - 高频词汇：动作="抓拍"、场景="接亲"、人群="伴娘"
   - 生成示例："谁懂啊！抓拍的接亲，伴娘都感动了"
...
4. **反面示例 - 避免AI腔**
   ...
   **堆砌形容词/过度夸张：**
   ...
   ❌ "绝绝子！美到窒息！封神了！yyds！"
   ❌ "每一张都美得像画一样，简直是艺术品级别的呈现"

   **机械套用/毫无变化：**
   ❌ 直接复制原标题"晨袍光影真的绝了"而不做任何变化
   ❌ 把"晨袍"换成"婚纱"，其他一模一样
   ❌ 所有标题都是"XX真的绝了"的重复
...
3. 标题字数加emoji符号，不能超过20个字符
4. 不要参考或复述当前已有标题，要全新创作
